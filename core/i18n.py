...
STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "finish_topic_hint": "填写研究主题后点击「复制启动说明」，粘贴到 AI 助手对话中发送。后续检索、确认、下载都会由助手引导，您无需打开任何说明文件。",
    ...
    "en": {
        ...
        "finish_topic_hint": "Enter your research topic, click “Copy starter message”, then paste it into your AI assistant chat. The assistant will guide search, review, and download — you do not need to open any documentation files.",
