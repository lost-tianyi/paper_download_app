...
STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "finish_subtitle": "环境已准备就绪，您可以立刻开始文献综述",
        "finish_ok": "配置完成，检查通过，可以开始使用",
        "finish_partial": "功能已安装。部分检查未通过，您仍可先试用推荐提示词",
        "finish_fail": "尚未完成安装，请返回查看说明并重试",
        "finish_next_steps": "建议按以下顺序开始：",
        "finish_step_1": "打开您刚才选择的 AI 助手（Codex / Claude Code / Cursor）。",
        "finish_step_2": "在下方输入研究主题，生成并复制推荐提示词，让助手完成文献检索并导出表格。",
        "finish_step_3": "人工审阅表格，把需要保留的文献标记为 Approved = Yes。",
        "finish_step_4": "如需通过学校/机构权限下载全文，请先在浏览器自行登录，再使用下载提示词处理已批准条目。",
        "finish_step_5": "将结果整理到 Zotero，并核对是否齐全。助手中也可查看「工作流程指南」。",
        "finish_topic_title": "生成适合您主题的提示词",
        "finish_topic_hint": "填写研究主题后，将自动生成可直接粘贴给 AI 助手的检索提示词。",
        "finish_topic_label": "研究主题",
        "finish_topic_placeholder": "例如：大语言模型辅助系统综述筛选",
        "finish_generate": "生成提示词",
        "finish_copy_recommended": "复制提示词",
        "finish_copy_search": "复制通用检索提示词",
        "finish_copy_download": "复制下载提示词",
        "finish_copied_recommended": "提示词已复制，可粘贴到 AI 助手中使用",
        "finish_copied_search": "通用检索提示词已复制",
        "finish_copied_download": "下载提示词已复制",
        "finish_need_topic": "请先填写研究主题",
        "finish_generated": "已根据您的主题生成提示词",
        "finish_template_path": "",
        "finish_note": "请勿向助手提供账号密码；请只使用您有权访问的资源。",
        "finish_preview": "提示词预览",
    ...
    "en": {
        ...
        "finish_subtitle": "Your environment is prepared for the literature-review workflow",
        "finish_ok": "Setup complete and verified. You can start now.",
        "finish_partial": "Features are installed. Some checks failed, but you can still try the prompts below.",
        "finish_fail": "Setup is incomplete. Go back, review the message, and try again.",
        "finish_next_steps": "Recommended next steps:",
        "finish_step_1": "Open the AI assistant you selected (Codex / Claude Code / Cursor).",
        "finish_step_2": "Enter your research topic below, generate a prompt, and let the assistant search and export a spreadsheet.",
        "finish_step_3": "Review the spreadsheet and mark papers to keep as Approved = Yes.",
        "finish_step_4": "For institutional access, sign in with your browser first, then use the download prompt on approved items.",
        "finish_step_5": "Organise results in Zotero and confirm nothing is missing. The workflow guide is also available in your assistant.",
        "finish_topic_title": "Create a prompt for your topic",
        "finish_topic_hint": "Enter your research topic to generate a ready-to-paste search prompt for your AI assistant.",
        "finish_topic_label": "Research topic",
        "finish_topic_placeholder": "e.g. LLM-assisted systematic literature screening",
        "finish_generate": "Generate prompt",
        "finish_copy_recommended": "Copy prompt",
        "finish_copy_search": "Copy general search prompt",
        "finish_copy_download": "Copy download prompt",
        "finish_copied_recommended": "Prompt copied — paste it into your AI assistant",
        "finish_copied_search": "General search prompt copied",
        "finish_copied_download": "Download prompt copied",
        "finish_need_topic": "Please enter a research topic first",
        "finish_generated": "Prompt created for your topic",
        "finish_template_path": "",
        "finish_note": "Never share account passwords with the assistant. Use only resources you are allowed to access.",
        "finish_preview": "Prompt preview",
